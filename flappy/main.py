...
if __name__ == "__main__":
    ...
    GAME_SPRITES["pipe"] = (
        pygame.image.load("gallery/sprites/tube_up.png").convert_alpha(),
        pygame.image.load("gallery/sprites/tube_down.png").convert_alpha()
    )
    ...
    GAME_SOUNDS["swooshing"] = pygame.mixer.Sound("gallery/audio/swoosh.wav")
